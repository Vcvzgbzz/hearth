...

{
  ...
  cfg.models.pinned = { backend: null, as: null, policy: "peer", peers: ["friend"], spilloverAt: 1, fallbackLocal: true, concurrency: null, params: null, lane: null, stats: null, emulate: null };
